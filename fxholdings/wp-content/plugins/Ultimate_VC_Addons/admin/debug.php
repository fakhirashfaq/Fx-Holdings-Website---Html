			            ...
			            <form method="post" id="ultimate_debug_settings">
			            	...
			            	<table class="form-table">
			        			<tbody>
									...
									?>
									<tr>
										<th scope="row"><?php echo __("Modal on Menu","ultimate_vc"); ?></th>
										<td> <div class="onoffswitch">
										<input type="checkbox" <?php echo $ultimate_modal_menu; ?> id="ultimate_modal_menu" value="enable" class="onoffswitch-checkbox" name="bsf_options[ultimate_modal_menu]" />
